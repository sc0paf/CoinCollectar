...
export const mtx = mainCanvas.getContext('2d');
...
export const drawBG = (grid, gridSize = 10) => {
...
const handleMouseDown = (mousePos) => {
    //click in canvas
    return;
};
